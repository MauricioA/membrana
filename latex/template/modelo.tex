...
\begin{itemize}
	...
	%Otro tipo de matriz particular que puede reducir los tiempos de ejecución de la resolución es la matriz banda, en la que 
\end{itemize}

%TODO aclarar que en los siguientes capítulos se explica en detalle etc
...
%			v_{asd}
%		}
%%		D_j = A_{ii} - \sigma_{j=1}^{i-1} L_{ij} v_j
%		\For {j = i+1 \ldots n} {
%%			L_{ij} = \left( A_{ji} - \sigma_{k=1}^{j-1} L_{jk} v_k \right) / D_i
%		}
%	}
%\end{algorithm}
...
%TODO agregar citas!!!
%libro iterative methods for sparse....
