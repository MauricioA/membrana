...
%section con detalles de implementación (mallado, librerías, lenguaje, etc) de última si está demasiado detallado se puede mover a otro lugar. explicar que se divide en 3 partes
\section{Implementación}
%TODO reescribir bien esto

%El problema fue divido en tres partes: el potencial eléctrico en el dominio al aplicar un pulso, la creación y evolución de poros en la membrana celular y el transporte de las especies de interés producto de las diferencias de potencial. Cada uno de estos sub-problemas se resolvió por separado numéricamente y los resultados fueron analizados en capítulos separados. Por último se acoplaron los tres sistemas...  completar \\
%
%Para resolver numéricamente las ecuaciones diferenciales de los distintos fenómenos físicos simulados se utilizaron los métodos de elementos finitos y diferencias finitas. 
%
%El trabajo se implementó desde cero en \texttt{C++}. 
%
%
%%primera versión conciso:
%
...
%escribir todo, después dividir en subsecciones
...
%primero escribir, después ordenar y corregir
%
%+dividido en 3 partes
%+detalles cpu
%+implementado en c++ y librerías
