...
\LARGE \textbf{Mauricio Alfonso} - LSC, FCEyN\\[0.5cm]
\LARGE \textbf{Alejandro Soba} - CSC-CONICET\\[0.5cm]
\LARGE \textbf{Guillermo Marshall} - INFIP, CONICET\\[0.5cm]
...
%		\item Librería Eigen para resolver sistemas de ecuaciones
	...
	\end{itemize}
		...
		\begin{center}
			...
			\captionof{figure}{\color{Green}Ejemplo de mallado de un dominio de tres materiales con elementos de 4 nodos}
		\end{center}
...
%	\end{center}\vspace{1cm}
	...
	\captionof{figure}{\color{Green} Radios de poros con $\alpha$ = 50\si{\micro\metre}, 160\kvm para t = 5\si{\micro\second}  y 5\si{\milli\second}}
	\end{center}\vspace{1cm}
...
\begin{multicols}{2} 
	\begin{center}\vspace{1cm}
		\includegraphics[width=1\linewidth]
		{final-h}
		\captionof{figure}{\color{Green} Concentración final de \h}
	\end{center}
...
\columnbreak
	...
	\begin{center}\vspace{1cm}
		\includegraphics[width=1\linewidth]
		{final-oh}
		\captionof{figure}{\color{Green} Concentración final de \oh}
	\end{center}
\end{multicols}
