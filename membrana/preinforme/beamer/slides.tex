...
%TODO explicar como se acoplan entre sí!! (como influyen los poros en la conductividad y difusión)
...
%			$C_i$ es la concentración de la especie $i$, $D_i$ el coeficiente de difusión de la 
		...
		\subsection{Acoplamiento} \frame{
			...
			\begin{center}
				$D_{i, \textrm{\tiny elem}} = D_i (1 - p) + D_p$
			\end{center}

%				Los poros aumentan la conductividad y difusión de la membrana: las regiones con más
%					\\ ESTO NO SE COMO EXPLICARLO
%					
					
%				La conductividad y la difusión en la membrana se calculan como el promedio
%					pesado entre la conductividad y difusión de la membrana sin poros y 
%					del líquido que llena los poros, con la proporción 
		}
